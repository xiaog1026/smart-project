...
public class XMLLoader {
	...
	private void loadDiagramContents(DiagramContents diagramContents,
		...
		this.diagram.setColumnMap(context.columnMap);
		this.diagram.setWordMap(context.wordMap);
	...
	private Word loadWord(Element element, LoadContext context) {
		...
		String length = this.getStringValue(element, "length");
		
		String decimal = this.getStringValue(element, "decimal");
		
		String array = this.getStringValue(element, "array");
		
		String array_dimension = this.getStringValue(element, "array_dimension");
		...
		word.setDecimal(decimal);
		word.setArray(array);
		word.setArray_dimension(array_dimension);
		word.setWordType("xml".equals(type) ? "jsonb" : type);
	...
	private NormalColumn loadNormalColumn(Element element, LoadContext context) {
		...
		String seqNo =  this.getStringValue(element, "seq_no");
		...
		normalColumn.setWordId(wordId);
		
		normalColumn.setSeqNo(seqNo);
...
//					element, context);
	...
	private ERTable loadTable(Element element, LoadContext context) {
		...
		table.setId(this.getStringValue(element, "id"));
